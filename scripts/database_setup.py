    ...
    def create_test_users(self):
        ...
        for user_data in test_users:
            try:
                ...
                print(f"Usuario creado: {user_data['email']} ({user_data['user_type']})")
    ...
    def create_sample_data(self, users):
        ...
        for user in users:
            ...
            for i in range(num_conversations):
                conversation_date = datetime.now() - timedelta(days=random.randint(1, 60))
                conversation = {
                    'user_id': user['id'],
                    ...
                    'messages': [
                        ...
                        },
                        {
                            ...
                            'timestamp': (conversation_date + timedelta(seconds=30)).isoformat()
                        }
                    ],
        ...
        try:
            ...
            if chatbot_conversations:
                self.mongo_db['chatbot_conversations'].insert_many(chatbot_conversations)
